...
export class DiagramSettings implements IShapeSizeSettings {
    ...
    private _pageSizeItems: any[] = [
        ...
        { size: new Size(47685, 67410), text: "A0 ({width} x {height})" },
        { size: new Size(33675, 47685), text: "A1 ({width} x {height})" },
        { size: new Size(23805, 33675), text: "A2 ({width} x {height})" },
        { size: new Size(16830, 23805), text: "A3 ({width} x {height})" },
        { size: new Size(11910, 16830), text: "A4 ({width} x {height})" },
        { size: new Size(8400, 11910), text: "A5 ({width} x {height})" },
        { size: new Size(5955, 8400), text: "A6 ({width} x {height})" },
        { size: new Size(4200, 5955), text: "A7 ({width} x {height})" }
    ];
