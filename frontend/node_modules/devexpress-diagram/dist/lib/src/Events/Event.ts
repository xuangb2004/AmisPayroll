...
export class MouseEventSource {
    constructor(
        ...
        public key?: ItemKey,
        public value?: string) { }
    get isConnector(): boolean { return this.type === MouseEventElementType.Connector || this.type === MouseEventElementType.ConnectorText; }
    get isShape(): boolean { return this.type === MouseEventElementType.Shape || this.type === MouseEventElementType.ShapeConnectionPoint; }
}
