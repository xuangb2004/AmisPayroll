...
import { TextEditorButton, LabelMode, SimplifiedSearchMode, EditorStyle, ValidationMessageMode, Position, ValidationStatus, HorizontalAlignment, VerticalAlignment, TextEditorButtonLocation, PositionAlignment, Direction, ButtonStyle, ToolbarItemLocation, ToolbarItemComponent } from "devextreme/common";
...
declare const DxSelectBox: import("vue").DefineComponent<{
    ...
    displayValue: StringConstructor;
...
export { DxSelectBox, DxAnimation, DxAt, DxBoundaryOffset, DxButton, DxCollision, DxDropDownOptions, DxFieldAddons, DxFrom, DxHide, DxItem, DxMy, DxOffset, DxOptions, DxPosition, DxShow, DxTo, DxToolbarItem };
