...
const DxCircularGauge = (0, vue_1.defineComponent)(componentConfig);
...
(0, index_2.prepareConfigurationComponentConfig)(DxGeometryConfig);
const DxGeometry = (0, vue_1.defineComponent)(DxGeometryConfig);
...
(0, index_2.prepareConfigurationComponentConfig)(DxRangeConfig);
const DxRange = (0, vue_1.defineComponent)(DxRangeConfig);
exports.DxRange = DxRange;
DxRange.$_optionName = "ranges";
DxRange.$_isCollectionItem = true;
DxRange.$_expectedChildren = {
...
(0, index_2.prepareConfigurationComponentConfig)(DxRangeContainerConfig);
const DxRangeContainer = (0, vue_1.defineComponent)(DxRangeContainerConfig);
...
(0, index_2.prepareConfigurationComponentConfig)(DxSubvalueIndicatorConfig);
const DxSubvalueIndicator = (0, vue_1.defineComponent)(DxSubvalueIndicatorConfig);
...
(0, index_2.prepareConfigurationComponentConfig)(DxTextConfig);
const DxText = (0, vue_1.defineComponent)(DxTextConfig);
...
(0, index_2.prepareConfigurationComponentConfig)(DxValueIndicatorConfig);
const DxValueIndicator = (0, vue_1.defineComponent)(DxValueIndicatorConfig);
