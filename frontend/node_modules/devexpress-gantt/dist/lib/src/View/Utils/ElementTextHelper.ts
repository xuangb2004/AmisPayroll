...
export class ElementTextHelper {
    ...
    getScaleItemText(date: Date, scaleType: ViewType, firstDayOfWeek: number = 0) : string {
    ...
    getWeeksScaleItemText(scaleItemDate: Date, isViewTypeScale: boolean, firstDayOfWeek: number): string {
        const weekStartDate = DateUtils.getWeekStartDate(scaleItemDate, firstDayOfWeek);
        const weekLastDayDate = DateUtils.getDSTCorrectedTaskEnd(weekStartDate, DateUtils.msPerWeek - DateUtils.msPerDay);
