...
class Lookup extends _m_drop_down_list.default {
    ...
    _renderInput() {
        ...
        this._$field = (0, _renderer.default)("<div>");
        this._applyInputAttributes(inputAttr);
        this._$field.addClass("dx-lookup-field");
    ...
    _setFocusPolicy() {
        ...
        this._runWithoutCloseOnScroll(() => {
            if (this.option("searchEnabled")) {
                ...
                var _this$_list0;
                null === (_this$_list0 = this._list) || void 0 === _this$_list0 || _this$_list0.focus()
            }
        })
    }
    _focusTarget() {
    ...
    _selectListItem(itemData, target) {
        var _this$_list1;
        null === (_this$_list1 = this._list) || void 0 === _this$_list1 || _this$_list1.selectItem(target);
        const {
            applyValueMode: applyValueMode
        } = this.option();
    ...
    _currentSelectedItem() {
        var _this$_list10;
        return this.option("grouped") ? this._list.option("selectedItems[0]").items[0] : null === (_this$_list10 = this._list) || void 0 === _this$_list10 ? void 0 : _this$_list10.option("selectedItems[0]")
    }
    _resetValue(e) {
        this._saveValueChangeEvent(e.event);
