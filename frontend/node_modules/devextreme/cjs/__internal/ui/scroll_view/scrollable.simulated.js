...
var _get_adjusted_base_container_size = require("../../ui/scroll_view/utils/get_adjusted_base_container_size");
...
class Scroller {
    ...
    _updateScrollbar() {
        (0, _common.deferUpdater)(() => {
            const dimension = this._dimension;
            const rawContainerSize = (0, _position.getBoundingRect)(this._$container[0])[dimension];
            ...
            const baseContainerSize = (0, _get_adjusted_base_container_size.getAdjustedBaseContainerSize)(rawContainerSize, rawBaseContainerSize, baseContentSize);
