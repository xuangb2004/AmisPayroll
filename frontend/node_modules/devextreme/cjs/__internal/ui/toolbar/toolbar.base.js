...
class ToolbarBase extends _collection_widget.default {
    ...
    _arrangeItems(width) {
        ...
        const beforeWidth = (0, _size.getOuterWidth)(null === (_this$_$beforeSection = this._$beforeSection) || void 0 === _this$_$beforeSection ? void 0 : _this$_$beforeSection.get(0)) ?? 0;
        const afterWidth = (0, _size.getOuterWidth)(null === (_this$_$afterSection = this._$afterSection) || void 0 === _this$_$afterSection ? void 0 : _this$_$afterSection.get(0)) ?? 0;
    ...
    _alignSectionLabels(labels, difference, expanding) {
        const getRealLabelWidth = label => (0, _size.getOuterWidth)(label) ?? 0;
