/**
 * DevExtreme (cjs/__internal/ui/text_box/text_editor.label.js)
 * Version: 25.2.7
    ...
    _attachEvents() {
        ...
        if (this._isVisible() && this._isOutsideMode()) {
            _events_engine.default.on(this._$labelSpan, clickEventName, e => {
                var _getWindow;
                const selectedText = null === (_getWindow = (0, _window.getWindow)()) || void 0 === _getWindow || null === (_getWindow = _getWindow.getSelection()) || void 0 === _getWindow ? void 0 : _getWindow.toString();
                if ("" === selectedText) {
