    ...
    _optionChanged(args) {
        ...
        switch (name) {
            ...
            case "endDateRange":
                ...
                break;
            case "selectedRowKey":
                null === (_this$_ganttTreeList16 = this._ganttTreeList) || void 0 === _this$_ganttTreeList16 || _this$_ganttTreeList16.selectRows(_uiGantt7.GanttHelper.getArrayFromOneElement(value));
                break;
            ...
            case "onTaskClick":
                ...
                break;
            case "onTaskDblClick":
                null === (_this$_actionsManager0 = this._actionsManager) || void 0 === _this$_actionsManager0 || _this$_actionsManager0.createTaskDblClickAction();
                break;
            case "onTaskInserting":
                null === (_this$_actionsManager1 = this._actionsManager) || void 0 === _this$_actionsManager1 || _this$_actionsManager1.createTaskInsertingAction();
                break;
            case "onTaskInserted":
                null === (_this$_actionsManager10 = this._actionsManager) || void 0 === _this$_actionsManager10 || _this$_actionsManager10.createTaskInsertedAction();
                break;
            case "onTaskDeleting":
                null === (_this$_actionsManager11 = this._actionsManager) || void 0 === _this$_actionsManager11 || _this$_actionsManager11.createTaskDeletingAction();
                break;
            case "onTaskDeleted":
                null === (_this$_actionsManager12 = this._actionsManager) || void 0 === _this$_actionsManager12 || _this$_actionsManager12.createTaskDeletedAction();
                break;
            case "onTaskUpdating":
                null === (_this$_actionsManager13 = this._actionsManager) || void 0 === _this$_actionsManager13 || _this$_actionsManager13.createTaskUpdatingAction();
                break;
            case "onTaskUpdated":
                null === (_this$_actionsManager14 = this._actionsManager) || void 0 === _this$_actionsManager14 || _this$_actionsManager14.createTaskUpdatedAction();
                break;
            case "onTaskMoving":
                null === (_this$_actionsManager15 = this._actionsManager) || void 0 === _this$_actionsManager15 || _this$_actionsManager15.createTaskMovingAction();
                break;
            case "onTaskEditDialogShowing":
                null === (_this$_actionsManager16 = this._actionsManager) || void 0 === _this$_actionsManager16 || _this$_actionsManager16.createTaskEditDialogShowingAction();
                break;
            case "onResourceManagerDialogShowing":
                null === (_this$_actionsManager17 = this._actionsManager) || void 0 === _this$_actionsManager17 || _this$_actionsManager17.createResourceManagerDialogShowingAction();
                break;
            case "onDependencyInserting":
                null === (_this$_actionsManager18 = this._actionsManager) || void 0 === _this$_actionsManager18 || _this$_actionsManager18.createDependencyInsertingAction();
                break;
            case "onDependencyInserted":
                null === (_this$_actionsManager19 = this._actionsManager) || void 0 === _this$_actionsManager19 || _this$_actionsManager19.createDependencyInsertedAction();
                break;
            case "onDependencyDeleting":
                null === (_this$_actionsManager20 = this._actionsManager) || void 0 === _this$_actionsManager20 || _this$_actionsManager20.createDependencyDeletingAction();
                break;
            case "onDependencyDeleted":
                null === (_this$_actionsManager21 = this._actionsManager) || void 0 === _this$_actionsManager21 || _this$_actionsManager21.createDependencyDeletedAction();
                break;
            case "onResourceInserting":
                null === (_this$_actionsManager22 = this._actionsManager) || void 0 === _this$_actionsManager22 || _this$_actionsManager22.createResourceInsertingAction();
                break;
            case "onResourceInserted":
                null === (_this$_actionsManager23 = this._actionsManager) || void 0 === _this$_actionsManager23 || _this$_actionsManager23.createResourceInsertedAction();
                break;
            case "onResourceDeleting":
                null === (_this$_actionsManager24 = this._actionsManager) || void 0 === _this$_actionsManager24 || _this$_actionsManager24.createResourceDeletingAction();
                break;
            case "onResourceDeleted":
                null === (_this$_actionsManager25 = this._actionsManager) || void 0 === _this$_actionsManager25 || _this$_actionsManager25.createResourceDeletedAction();
                break;
            case "onResourceAssigning":
                null === (_this$_actionsManager26 = this._actionsManager) || void 0 === _this$_actionsManager26 || _this$_actionsManager26.createResourceAssigningAction();
                break;
            case "onResourceAssigned":
                null === (_this$_actionsManager27 = this._actionsManager) || void 0 === _this$_actionsManager27 || _this$_actionsManager27.createResourceAssignedAction();
                break;
            case "onResourceUnassigning":
                null === (_this$_actionsManager28 = this._actionsManager) || void 0 === _this$_actionsManager28 || _this$_actionsManager28.createResourceUnassigningAction();
                break;
            case "onResourceUnassigned":
                null === (_this$_actionsManager29 = this._actionsManager) || void 0 === _this$_actionsManager29 || _this$_actionsManager29.createResourceUnassignedAction();
                break;
            case "onCustomCommand":
                null === (_this$_actionsManager30 = this._actionsManager) || void 0 === _this$_actionsManager30 || _this$_actionsManager30.createCustomCommandAction();
                break;
            case "onContextMenuPreparing":
                null === (_this$_actionsManager31 = this._actionsManager) || void 0 === _this$_actionsManager31 || _this$_actionsManager31.createContextMenuPreparingAction();
                break;
            case "onScaleCellPrepared":
                null === (_this$_actionsManager32 = this._actionsManager) || void 0 === _this$_actionsManager32 || _this$_actionsManager32.createScaleCellPreparedAction();
                break;
            case "allowSelection":
                null === (_this$_ganttTreeList17 = this._ganttTreeList) || void 0 === _this$_ganttTreeList17 || _this$_ganttTreeList17.setOption("selection.mode", _uiGantt7.GanttHelper.getSelectionMode(value));
                this._setGanttViewOption("allowSelection", value);
                break;
            case "showRowLines":
                null === (_this$_ganttTreeList18 = this._ganttTreeList) || void 0 === _this$_ganttTreeList18 || _this$_ganttTreeList18.setOption("showRowLines", value);
            ...
            case "taskContentTemplate":
                ...
                break;
            case "rootValue":
                null === (_this$_ganttTreeList19 = this._ganttTreeList) || void 0 === _this$_ganttTreeList19 || _this$_ganttTreeList19.setOption("rootValue", value);
                break;
            case "width":
            ...
            case "height":
                ...
                break;
            case "sorting":
                null === (_this$_ganttTreeList20 = this._ganttTreeList) || void 0 === _this$_ganttTreeList20 || _this$_ganttTreeList20.setOption("sorting", this.option(name));
                break;
            case "filterRow":
                null === (_this$_ganttTreeList21 = this._ganttTreeList) || void 0 === _this$_ganttTreeList21 || _this$_ganttTreeList21.setOption("filterRow", this.option(name));
                break;
            case "headerFilter":
                null === (_this$_ganttTreeList22 = this._ganttTreeList) || void 0 === _this$_ganttTreeList22 || _this$_ganttTreeList22.setOption("headerFilter", this.option(name));
                break;
            default:
                super._optionChanged(args)
        }
