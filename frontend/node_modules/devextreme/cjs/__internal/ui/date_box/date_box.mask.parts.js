/**
 * DevExtreme (cjs/__internal/ui/date_box/date_box.mask.parts.js)
 * Version: 25.2.7
...
const getLimits = (pattern, date, forcedPattern) => {
    ...
    return limits[forcedPattern ?? pattern] ?? {
        min: 0,
        max: 0
    }
};
...
const monthSetter = (date, value) => {
    ...
    const newValue = (0, _math.fitIntoRange)(+value, monthLimits.min, monthLimits.max);
...
const renderDateParts = (text, regExpInfo) => {
    ...
    for (let i = 1; i < result.length; i += 1) {
        ...
        sections.push({
            ...
            pattern: pattern,
            text: result[i],
            limits: (date, forcedPattern) => getLimits(pattern[0], date, forcedPattern),
