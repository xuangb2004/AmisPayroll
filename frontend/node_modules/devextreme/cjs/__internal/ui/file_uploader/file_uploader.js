...
class FileUploader extends _editor.default {
    ...
    _getTotalFilesSize() {
        if (!this._totalFilesSize) {
            ...
            null === (_this$_files0 = this._files) || void 0 === _this$_files0 || _this$_files0.forEach(file => {
    ...
    _getTotalLoadedFilesSize() {
        if (!this._totalLoadedFilesSize) {
            ...
            null === (_this$_files1 = this._files) || void 0 === _this$_files1 || _this$_files1.forEach(file => {
