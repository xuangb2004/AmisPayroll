...
class FileItemsController {
    ...
    moveItems(itemInfos, destinationDirectory) {
        ...
        return this._processEditAction(actionInfo, (args, itemInfo) => {
            ...
            null === (_this$_editingEvents0 = this._editingEvents) || void 0 === _this$_editingEvents0 || null === (_this$_editingEvents1 = _this$_editingEvents0.onItemMoved) || void 0 === _this$_editingEvents1 || _this$_editingEvents1.call(_this$_editingEvents0, args)
    ...
    copyItems(itemInfos, destinationDirectory) {
        ...
        return this._processEditAction(actionInfo, (args, itemInfo) => {
            ...
            args.item = itemInfo.fileItem;
            args.destinationDirectory = destinationDirectory.fileItem;
            null === (_this$_editingEvents10 = this._editingEvents) || void 0 === _this$_editingEvents10 || null === (_this$_editingEvents11 = _this$_editingEvents10.onItemCopying) || void 0 === _this$_editingEvents11 || _this$_editingEvents11.call(_this$_editingEvents10, args)
        }, item => {
            ...
            null === (_this$_editingEvents12 = this._editingEvents) || void 0 === _this$_editingEvents12 || null === (_this$_editingEvents13 = _this$_editingEvents12.onItemCopied) || void 0 === _this$_editingEvents13 || _this$_editingEvents13.call(_this$_editingEvents12, args)
        }, needChangeCurrentDirectory => {
            if (needChangeCurrentDirectory) {
    ...
    deleteItems(itemInfos) {
        ...
        return this._processEditAction(actionInfo, (args, itemInfo) => {
            ...
            args.item = itemInfo.fileItem;
            null === (_this$_editingEvents14 = this._editingEvents) || void 0 === _this$_editingEvents14 || null === (_this$_editingEvents15 = _this$_editingEvents14.onItemDeleting) || void 0 === _this$_editingEvents15 || _this$_editingEvents15.call(_this$_editingEvents14, args)
        }, item => {
            ...
            return null === (_this$_editingEvents16 = this._editingEvents) || void 0 === _this$_editingEvents16 || null === (_this$_editingEvents17 = _this$_editingEvents16.onItemDeleted) || void 0 === _this$_editingEvents17 ? void 0 : _this$_editingEvents17.call(_this$_editingEvents16, {
    ...
    uploadFileChunk(fileData, chunksInfo, destinationDirectory) {
        ...
        if (0 === chunksInfo.chunkIndex) {
            ...
            startDeferred = this._processBeforeItemEditAction(args => {
                ...
                null === (_this$_editingEvents18 = this._editingEvents) || void 0 === _this$_editingEvents18 || null === (_this$_editingEvents19 = _this$_editingEvents18.onFileUploading) || void 0 === _this$_editingEvents19 || _this$_editingEvents19.call(_this$_editingEvents18, args)
            })
        } else {
        ...
        if (chunksInfo.chunkIndex === chunksInfo.chunkCount - 1) {
            result = result.done(() => {
                ...
                null === (_this$_editingEvents20 = this._editingEvents) || void 0 === _this$_editingEvents20 || null === (_this$_editingEvents21 = _this$_editingEvents20.onFileUploaded) || void 0 === _this$_editingEvents21 || _this$_editingEvents21.call(_this$_editingEvents20, args)
            })
        }
        return result
    }
    ...
    downloadItems(itemInfos) {
        const deferreds = itemInfos.map(itemInfo => this._processBeforeItemEditAction(args => {
            ...
            args.item = itemInfo.fileItem;
            null === (_this$_editingEvents22 = this._editingEvents) || void 0 === _this$_editingEvents22 || null === (_this$_editingEvents23 = _this$_editingEvents22.onItemDownloading) || void 0 === _this$_editingEvents23 || _this$_editingEvents23.call(_this$_editingEvents22, args)
        }, itemInfo));
        return (0, _deferred.when)(...deferreds).then(() => {
            var _this$_fileProvider0;
            const items = itemInfos.map(i => i.fileItem);
            return (0, _deferred.when)(this._getItemActionResult(null === (_this$_fileProvider0 = this._fileProvider) || void 0 === _this$_fileProvider0 ? void 0 : _this$_fileProvider0.downloadItems(items))).then(() => {}, errorInfo => {
    ...
    getItemContent(itemInfos) {
        ...
        const items = itemInfos.map(i => i.fileItem);
        return (0, _deferred.when)(null === (_this$_fileProvider1 = this._fileProvider) || void 0 === _this$_fileProvider1 ? void 0 : _this$_fileProvider1.getItemsContent(items))
    }
