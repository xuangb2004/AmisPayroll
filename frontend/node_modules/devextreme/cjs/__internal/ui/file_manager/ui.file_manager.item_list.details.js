...
class FileManagerDetailsItemList extends _uiFile_manager3.default {
    ...
    _setSelectedItemKeys(itemKeys) {
        ...
        null === (_this$_filesView0 = this._filesView) || void 0 === _this$_filesView0 || _this$_filesView0.option("selectedRowKeys", itemKeys)
    }
    _setFocusedItemKey(itemKey) {
        var _this$_filesView1;
        null === (_this$_filesView1 = this._filesView) || void 0 === _this$_filesView1 || _this$_filesView1.option("focusedRowKey", itemKey)
    }
    clearSelection() {
        if (this._isMultipleSelectionMode()) {
            var _this$_filesView10;
            null === (_this$_filesView10 = this._filesView) || void 0 === _this$_filesView10 || _this$_filesView10.clearSelection()
        } else {
            var _this$_filesView11;
            null === (_this$_filesView11 = this._filesView) || void 0 === _this$_filesView11 || _this$_filesView11.option("focusedRowIndex", -1)
        }
    }
    refresh(options, operation) {
        ...
        null === (_this$_filesView12 = this._filesView) || void 0 === _this$_filesView12 || _this$_filesView12.option(actualOptions);
    ...
    _getScrollable() {
        ...
        return null === (_this$_filesView13 = this._filesView) || void 0 === _this$_filesView13 ? void 0 : _this$_filesView13.getScrollable()
    }
    getSelectedItems() {
        if (this._isMultipleSelectionMode()) {
            var _this$_filesView14;
            return null === (_this$_filesView14 = this._filesView) || void 0 === _this$_filesView14 ? void 0 : _this$_filesView14.getSelectedRowsData()
        }
