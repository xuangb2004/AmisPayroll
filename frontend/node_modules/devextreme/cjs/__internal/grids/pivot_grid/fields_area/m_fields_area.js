...
class FieldsArea extends _m_area_item.AreaItem {
    ...
    _getPopupOptions(row, button) {
        return {
            contentTemplate: () => (0, _renderer.default)("<div>").append((0, _renderer.default)("<table>").addClass("dx-area-field-container").append((0, _renderer.default)("<thead>").addClass("dx-pivotgrid-fields-area-head").append(row))),
            height: "auto",
            width: "auto",
            position: {
                at: "left",
