...
class AreaItem {
    ...
    _getRowElement(index) {
        ...
        if ((null === (_this$_tableElement = this._tableElement) || void 0 === _this$_tableElement ? void 0 : _this$_tableElement.length) > 0) {
    ...
    _getRowHeight(index) {
        ...
        if (null !== row && void 0 !== row && row.lastChild) {
            const {
                height: height
    ...
    getColumnsWidth() {
        ...
        for (let rowIndex = 0; rowIndex < rowsLength; rowIndex += 1) {
            ...
            const row = this._getRowElement(rowIndex);
            Array.from(row.cells).forEach(cell => {
                ...
                for (let rowOffset = 0; rowOffset < cell.rowSpan; rowOffset += 1) {
                    for (let columnOffset = 0; columnOffset < cell.colSpan; columnOffset += 1) {
                        processedCells[_a = rowIndex + rowOffset] || (processedCells[_a] = []);
                        processedCells[rowIndex + rowOffset][columnIndex + columnOffset] = true
                    }
                }
                if (void 0 === colSpans[columnIndex] || cell.colSpan < colSpans[columnIndex]) {
