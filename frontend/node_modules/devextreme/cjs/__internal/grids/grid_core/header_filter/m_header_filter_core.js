    ...
    _initializePopupContainer(options) {
        ...
        const dxPopupOptions = {
            ...
            toolbarItems: [{
                ...
                widget: "dxButton",
                options: {
                    text: headerFilterOptions.texts.ok ?? _message.default.format("dxDataGrid-headerFilterOK"),
                    onClick() {
                ...
                widget: "dxButton",
                options: {
                    text: headerFilterOptions.texts.cancel ?? _message.default.format("dxDataGrid-headerFilterCancel"),
                    onClick() {
                        that.hideHeaderFilterMenu();
