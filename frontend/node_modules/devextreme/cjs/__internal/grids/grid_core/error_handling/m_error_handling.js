...
class ErrorHandlingController extends _m_modules.default.ViewController {
    ...
    _renderErrorMessage(error) {
        ...
        const $message = (0, _renderer.default)("<div>").addClass("dx-error-message").text(message);
        this.setAria("role", "alert", $message);
        this.setAria("roledescription", _message.default.format("dxDataGrid-ariaError"), $message);
        if (error.url) {
