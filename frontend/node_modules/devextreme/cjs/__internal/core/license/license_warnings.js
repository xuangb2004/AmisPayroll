/**
 * DevExtreme (cjs/__internal/core/license/license_warnings.js)
 * Version: 25.2.7
...
exports.logLicenseWarning = logLicenseWarning;
const TEMPLATES = exports.TEMPLATES = Object.freeze({
    warningPrefix: code => {
...
function logLicenseWarning(warningType, version, versionInfo) {
    const T = TEMPLATES;
