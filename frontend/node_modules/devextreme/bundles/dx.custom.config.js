...
require('devextreme/bundles/modules/core.legacy');
...
require('devextreme/common/core/localization/globalize/core');
require('devextreme/common/core/localization/globalize/message');
require('devextreme/common/core/localization/globalize/number');
require('devextreme/common/core/localization/globalize/date');
require('devextreme/common/core/localization/globalize/currency');

/* Events (dx.module-core.js) */

require('devextreme/common/core/events/click');
require('devextreme/common/core/events/contextmenu');
require('devextreme/common/core/events/double_click');
require('devextreme/common/core/events/drag');
require('devextreme/common/core/events/hold');
require('devextreme/common/core/events/hover');
require('devextreme/common/core/events/pointer');
require('devextreme/common/core/events/swipe');
require('devextreme/common/core/events/transform');


/* Data (dx.module-core.js) */

const data = DevExpress.data = require('devextreme/bundles/modules/data');
require('devextreme/bundles/modules/data.legacy');

data.odata = require('devextreme/bundles/modules/data.odata');
require('devextreme/bundles/modules/data.odata.legacy');
...
ui.dxInformer = require('devextreme/ui/informer');
...
ui.dxRecurrenceEditor = require('devextreme/ui/recurrence_editor');
...
ui.dxSpeechToText = require('devextreme/ui/speech_to_text');
ui.dxSpeedDialAction = require('devextreme/ui/speed_dial_action');
ui.dxStepper = require('devextreme/ui/stepper');
...
ui.dxCardView = require('devextreme/ui/card_view');
