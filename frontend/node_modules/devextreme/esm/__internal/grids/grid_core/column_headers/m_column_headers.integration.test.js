/**
 * DevExtreme (esm/__internal/grids/grid_core/column_headers/m_column_headers.integration.test.js)
 * Version: 25.2.7
...
describe("Column Headers", () => {
            ...
            const {
                ...
                columns: [{
                    ...
                    headerCellTemplate(headerElement) {
                        $("<span>").text("Test").appendTo(headerElement)
                    }
                }]
            });
    ...
    describe("when cellHintEnabled: true", () => {
        it("should show column caption in the tooltip instead of sort index when hovering sort indicator (T1321834)", async () => {
            ...
            const headerContentElement = component.getHeaderCell(0).getHeaderContent();
        ...
        it("should show cell text in the tooltip for non-header rows", async () => {
            const {
                ...
                dataSource: [{
                    id: 1,
                    Position: "Very Long Position Name That Should Be Truncated"
                }],
                columns: [{
                    dataField: "Position",
                    caption: "Position",
            ...
            const dataCell = instance.getCellElement(0, 0);
