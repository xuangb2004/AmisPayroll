            ...
            const rectsByPages = splitByPages(jsPDFDocument, rowsInfo, options, _ref => {
                ...
                if (isTextNotEmpty) {
                    ...
                    if (isTextHeightGreaterThanRect || !isTextTopAlignment) {
                        ...
                        if ("top" === (null === (_sourceRect$sourceCel0 = sourceRect.sourceCellInfo) || void 0 === _sourceRect$sourceCel0 ? void 0 : _sourceRect$sourceCel0.verticalAlign)) {
                            topTextTopOffset = sourceRect.sourceCellInfo._textTopOffset ?? 0;
                            bottomTextTopOffset = topTextTopOffset - topRect.h
                        } else if ("middle" === (null === (_sourceRect$sourceCel1 = sourceRect.sourceCellInfo) || void 0 === _sourceRect$sourceCel1 ? void 0 : _sourceRect$sourceCel1.verticalAlign)) {
                        ...
                        } else if ("bottom" === (null === (_sourceRect$sourceCel10 = sourceRect.sourceCellInfo) || void 0 === _sourceRect$sourceCel10 ? void 0 : _sourceRect$sourceCel10.verticalAlign)) {
