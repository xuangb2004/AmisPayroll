/**
 * DevExtreme (esm/__internal/scheduler/appointments_new/appointment_collector.test.js)
 * Version: 25.2.7
...
import {
    ...
    getAppointmentCollectorProperties as getProperties
...
describe("AppointmentCollector", () => {
    ...
    describe("Classes", () => {
        ...
        it.each([true, false])("should have correct compact class for isCompact = %o", isCompact => {
            const instance = createAppointmentCollector(Object.assign({}, getProperties([defaultAppointmentData]), {
                isCompact: isCompact
            }));
    ...
    describe("Aria", () => {
        it("should have correct aria-roledescription when appointment is in the same date", () => {
            const instance = createAppointmentCollector(getProperties([{
                text: "test",
                startDate: new Date(2024, 0, 1, 9, 0),
                endDate: new Date(2024, 0, 1, 10, 0)
            }]));
    ...
    describe("Text", () => {
        ...
        it("should have correct text for two appointments and isCompact = true", () => {
            const instance = createAppointmentCollector(Object.assign({}, getProperties([Object.assign({}, defaultAppointmentData), Object.assign({}, defaultAppointmentData)]), {
                isCompact: true
            }));
            const $buttonContent = instance.$element().find(".dx-button-content");
