export declare function addBrowserClassNamesToHtml(): void;
export declare class Browser {
    ...
    static applyClassNamesOnDemand(documentElement: HTMLElement, documentElementClassName: string): Promise<void>;
