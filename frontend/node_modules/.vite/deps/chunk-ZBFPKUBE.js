...
import {
  defineComponent
} from "./chunk-BHBPUP3H.js";

// node_modules/devextreme-vue/esm/tree-view.js
var componentConfig = {
  props: {
    accessKey: String,
  ...
  beforeCreate() {
    this.$_WidgetClass = tree_view_default;
...
var DxTreeView = defineComponent(componentConfig);
var DxButtonConfig = {
  emits: {
    "update:isActive": null,
    "update:hoveredElement": null,
...
var DxOptions = defineComponent(DxOptionsConfig);
DxOptions.$_optionName = "options";
var DxSearchEditorOptionsConfig = {
  emits: {
    "update:isActive": null,
    "update:hoveredElement": null,
    "update:accessKey": null,
...
var DxSearchEditorOptions = defineComponent(DxSearchEditorOptionsConfig);
DxSearchEditorOptions.$_optionName = "searchEditorOptions";
DxSearchEditorOptions.$_expectedChildren = {
  button: { isCollectionItem: true, optionName: "buttons" }
};
var tree_view_default2 = DxTreeView;
...
export {
  ...
  tree_view_default2 as tree_view_default
};
//# sourceMappingURL=chunk-ZBFPKUBE.js.map
